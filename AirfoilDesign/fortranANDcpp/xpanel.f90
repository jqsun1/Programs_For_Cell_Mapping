...
!
      ...
      IF (DBUGMOD) WRITE(*,*) 'Calculating unit vorticity distributions ...'
!
      DO 10 I=1, N
        GAM(I) = 0.
        GAMU(I,1) = 0.
...
!-----------------------------------------------------
      INCLUDE 'XFOIL.INC'
!
      IF (DBUGMOD) WRITE(*,*) 'Calculating source influence matrix ...'
!
      IF(.NOT.LADIJ) THEN
!
...
!-----------------------------------------------------
      INCLUDE 'XFOIL.INC'
!
      IF (DBUGMOD) WRITE(*,*) 'Calculating wake trajectory ...'
!
...
!
   ...
   10 CONTINUE
!
      IF (DBUGMOD) WRITE(*,*) 'STFIND: Stagnation point not found. Continuing ...'
      I = N/2
!
   11 CONTINUE
!
...
!
      ...
      IF(IBLMAX.GT.IVX) THEN
        IF (DBUGMOD) WRITE(*,*) ' ***  BL array overflow.'
        IF (DBUGMOD) WRITE(*,*) ' ***  Increase IVX to at least', IBLMAX
        STOP
      ENDIF
!
      LIPAN = .TRUE.
